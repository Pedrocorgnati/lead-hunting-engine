...
export default function AdminError({
  ...
  return (
    <div data-testid="admin-error" className="flex flex-col items-center justify-center gap-4 py-16 text-center">
      <div className="rounded-full bg-destructive/10 p-4">
        <AlertTriangle className="h-8 w-8 text-destructive" aria-hidden={true} />
      </div>
      <div className="space-y-1">
        <p className="font-medium text-foreground">Erro na área admin</p>

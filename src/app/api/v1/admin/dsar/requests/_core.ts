// Core compartilhado do DSAR admin (extraido de route.ts: o type-check de
// rotas do Next proibe exports nao-handler em route.ts; quebrava o build
// webpack). Tipos + findDsarDetail + builders consumidos por GET, detalhe,
// evidencias e mutacoes.
...
export async function loadRelatedEvents(starts: AuditWithUser[]): Promise<Map<string, AuditWithUser[]>> {

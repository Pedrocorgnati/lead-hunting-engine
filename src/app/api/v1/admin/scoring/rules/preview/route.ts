...
/**
 * POST /api/v1/admin/scoring/rules/preview
 *
 * Simula impacto de alterar o peso de UMA regra. Nao persiste.
 * Alias canonico para /api/v1/admin/config/scoring-rules/preview.
 *

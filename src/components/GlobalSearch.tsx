...
export function GlobalSearch() {
  ...
  const commands = useMemo<Command[]>(
    () => [
      ...
      { id: 'go-primeiros-passos', label: 'Primeiros passos', group: 'Navegacao', icon: FileText, keywords: 'onboarding guia inicio checklist', href: '/primeiros-passos' },
      ...
      { id: 'go-admin-provedores', label: 'Provedores (admin)', group: 'Admin', icon: Database, keywords: 'providers saude status quota', href: '/admin/provedores', adminOnly: true },
      { id: 'go-admin-credenciais', label: 'Credenciais (admin)', group: 'Admin', icon: Shield, keywords: 'api keys chaves credenciais', href: '/admin/credenciais', adminOnly: true },
